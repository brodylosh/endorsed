...
# Athlete.create(first_name: 'C.J.', last_name: 'Stroud', university: 'Ohio State University', sport: 'Football', year: 'Sophomore', birthday: Date.today, gender: 'Male', bio: 'OH-IO', email: 'cjstroud@gmail.com', phone_number: '6140000000', username: 'cjstroud', password: 'CJStroud123!', athlete: true)
